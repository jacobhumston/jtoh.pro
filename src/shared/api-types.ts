        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        'application/json': components['schemas']['RobloxLimitedSchema'][];
                    };
                };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        'application/json': components['schemas']['UserOwnedRobloxLimitedsSchema'];
                    };
                };
...
export interface components {
    schemas: {
        ...
        RobloxLimitedSchema: {
            /** @description Name of this limited. */
            name: string;
            /** @description ID of this limited. */
            id: string;
            /**
             * Format: uri
             * @description Picture of this item.
             */
            picture: string;
            /** @description RAP of this item. */
            rap: number;
            /** @description Value of this item. Can be null if Rolimons has not valued it. */
            value: number | null;
        };
        UserOwnedRobloxLimitedsSchema: {
            [key: string]: number;
        };
        PingSchema: {
