...
declare -A commands
    ...
    commands["backup-dbs"]="${dir_bun} run tools/db-backup.ts"
    ...
    commands["start-jacobs-assistant"]="${dir_bunx} pm2 start \"${dir_bun} run tools/jacobs-assistant-sender.ts --dev\" --name Jacobs-Assistant"
